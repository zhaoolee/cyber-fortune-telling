...
export interface ApiAnythingResponseAnythingResponse
  extends Struct.CollectionTypeSchema {
  collectionName: 'anything_responses';
  info: {
    description: '';
    displayName: '\u54CD\u5E94\u6D88\u606F\u7F13\u5B58';
    pluralName: 'anything-responses';
    singularName: 'anything-response';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::anything-response.anything-response'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    request_url: Schema.Attribute.String;
    response_data: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFortuneTellingUserFortuneTellingUser
  extends Struct.CollectionTypeSchema {
  collectionName: 'fortune_telling_users';
  info: {
    description: '';
    displayName: '\u7B97\u547D\u7528\u6237';
    pluralName: 'fortune-telling-users';
    singularName: 'fortune-telling-user';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSignInSignIn extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sign_in_date_list: Schema.Attribute.JSON;
    sign_in_uid: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::anything-response.anything-response': ApiAnythingResponseAnythingResponse;
      'api::fortune-telling-user.fortune-telling-user': ApiFortuneTellingUserFortuneTellingUser;
